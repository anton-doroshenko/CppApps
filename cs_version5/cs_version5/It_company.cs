	...
	public void setVacList(List<string> vl)
  {
   ...
   public void setStatic()
   {
    ...
    public void companyWorking()
    {
	    ...
	    {
		    Console.WriteLine("For this candidate there is not vacancies in company");
	    }
	    if (hr_manager[0].candidate[0].getState() == "FailTest")
	    {
		    Console.WriteLine("Candidate can`t take test");
	    }
	    if (hr_manager[0].candidate[0].getState() == "Fail")
	    {
            Console.WriteLine("Candidate can`t pass interview");
	    }
        if (hr_manager[0].candidate[0].getState() == "GetWork")
	    {
		    Console.WriteLine("Candidate get work!");
		    try
		    {
   ...
   public static bool operator ==(It_company left, It_company right)
   {
       return left.curValueOfWorkers == right.curValueOfWorkers;
   }
   ...
   public static It_company operator ++(It_company itcompany)
   {
       itcompany.curValueOfWorkers++;
       return itcompany;
   }
