...
It_company::It_company(std::string name, std::vector<std::string> vacancies, int maxValueOfWorkers, int curValueOfWorkers):
	technical_manager(1),
	hr_manager(1),
	name(name),
	vacancyList(vacancies),
	maxValueOfWorkers(maxValueOfWorkers),
	curValueOfWorkers(curValueOfWorkers)
{
...
int It_company::getMaxValueOfWorkers(void)
{
	return maxValueOfWorkers;
}

int It_company::getCurValueOfWorkers(void)
{
...
void It_company::setMaxValueOfWorkers(int max)
{
	maxValueOfWorkers = max;
}

void It_company::setCurValueOfWorkers(int cur)
{
