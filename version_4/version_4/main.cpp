...
int main()
{
	...
	std::cout << "/// __________VERTION_4_________ ///" << std::endl;
	std::cout << "/////////////////////////////////////" << std::endl;
	system("pause");
	system("cls");
	...
	std::cout << std::endl;
	{
		...
		std::cout << std::endl;
		//std::cout << "////////////////////////////////" << std::endl;
		//std::cout << "/// Main objects are created ///" << std::endl;
		//std::cout << "////////////////////////////////" << std::endl;
		//std::cout << std::endl;
		...
		//	for (int k = 0; k < itcompany.technical_manager[i].interview.size(); k++)
		//	{
		//		std::cout << "     " << k + 1 << ". " << "Result: " << itcompany.technical_manager[i].interview[k]->successOfPassing() << std::endl;
		//	}
		//}
		//std::cout << std::endl;
		//std::cout << "- HR-managers" << std::endl;
		...
		//	<< "Name: " << candidate.resume.getName() << std::endl << "Birthday: " << candidate.resume.getBirthday() << std::endl;
		//std::cout << "Courses:" << std::endl;
		//candidate.resume.getCourses();
		//std::cout << "Languages:" << std::endl;
		//candidate.resume.getLanguages();
		//std::cout << "Phone numbers:" << std::endl;
		//candidate.resume.getPhones();
		//std::cout << std::endl;*/
		////displayGeters(itcompany, candidate);
		////displaySeters(itcompany, candidate);
		////std::cout << "After setting new values: " << std::endl;
		////displayGeters(itcompany, candidate);
		//std::cout << "///////////////////////////////////////////////////////" << std::endl;
		//std::cout << "/// Use of constant atributes and methods (getters) ///" << std::endl;
		//std::cout << "///////////////////////////////////////////////////////" << std::endl;
		//std::cout << std::endl;
		//displayGeters(itcompany, candidate);
		//std::cout << "///////////////////////////////////////////" << std::endl;
		//std::cout << "/// Use of static atributes and methods ///" << std::endl;
		//std::cout << "///////////////////////////////////////////" << std::endl;
		//std::cout << "Maximal amount of personal in IT-company (static constant var): ";
		//std::cout << std::endl;
		//std::cout << It_company::getMaxValueOfWorkers() << std::endl;
		//delTestInterview(itcompany);
		//std::cout << std::endl;
	}
	/*std::cout << "////////////////////////////////////////////////" << std::endl;
	...
	std::cout << std::endl;
	{
		...
		std::cout << std::endl;
		It_company itcompany4("name__vacancy_vacanc_vacan3_vacan4_vacan5");
		std::cout << std::endl;
	...
	}
	{
		...
		std::cout << std::endl;
		Resume resume4("aimCompetenceCourse1Course2_educationEngRusUkr_02antonDoroshenko1@gmail.com620829666264_addressNameBirthday");
		std::cout << std::endl;
